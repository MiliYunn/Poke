<script lang="ts">
  ...
  type ScamHistoryItem={id?:string;target:string;description?:string;chainId?:number;chainName?:string;result:ScamResult;inferences?:Array<{requestId:string;model:string;analysis:{riskLevel:string;truthScore:number}}>;consensus?:string;scannedAt?:string};
